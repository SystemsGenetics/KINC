...
# Instituation:  Feltus Lab, Clemson University
# Date:  May 15, 2012
#
# This script reads a binary correlation file generated by the RMTGeneNet 
# package and can generate a network file given a threshold value. It can
# also be used to investiage correlation values of specific elments.
#
# Usage: see the help documentation for usage instructions:  
#
#    parse_pearson_bin.pl --help
#
#------------------------------------------------------------------------------
